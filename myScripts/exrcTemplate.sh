chapter_section="Section 10." # Update needed here
chapter="10"    # Update needed here

chapterName="Program Organization"    # Give chapter name here
...
exrcCount=3    # Update the number of exercises here
emptyLine="  "
