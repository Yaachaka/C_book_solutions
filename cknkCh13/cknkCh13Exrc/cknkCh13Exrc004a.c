/********************************************************************************
 * File: cknkCh13Exrc004a.c
 * Author: Yaachaka
 * Purpose: read_line function modification to skip white space before beginning to store input characters.
 ********************************************************************************/
...
int read_line(char str[], int n)
{
    ...
    {
        ;    // Do nothing
    }	// while statement: ignore preceeding white space characters
