/********************************************************************************
 * File: cknkCh13Exrc005a.c
 * Author: Yaachaka
 * Purpose: capitalize function capitalize all letters in its argument. Use array subscripting to access the characters in the sctring
 ********************************************************************************/
