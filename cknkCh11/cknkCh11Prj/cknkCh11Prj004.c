 ...
 * Return type: void
 * Return value description: 
 * Parameters: int num_in_rank[], int num_in_suit[]
 * Param1 descr.: 
 * Param2 descr.: 
 * Param3 descr.: 
 ...
 * Return type: void
 * Return value description: 
 * Parameters: int num_in_rank[], int num_in_suit[], bool *straight, bool *flush, bool *four, bool *three, int *pairs
 * Param1 descr.: 
 * Param2 descr.: 
 * Param3 descr.: 
...
void analyze_hand(int num_in_rank[], int num_in_suit[], bool *straight, bool *flush, bool *four, bool *three, int *pairs)
{
    ...
    *pairs = 0;
    ...
    for(rank = 0; rank < NUM_RANKS; rank++)
    {
        ...
        {
            (*pairs)++;    // NOTE: The parentheses is necessary. Or else, the post-increment operator takes precedence over the indirection operator. 
        }	// if condition: 
    }	// for statement: 
 ...
 * Return type: void
 * Return value description: 
 * Parameters: bool *straight, bool *flush, bool *four, bool *three, int *pairs
 * Param1 descr.: 
 * Param2 descr.: 
 * Param3 descr.: 
